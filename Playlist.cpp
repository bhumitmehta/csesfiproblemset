...
int main(){
    ...
    // In this problem we have to find the longest subarray with distinct elements
    // we willl use two pointer approach to solve this problem 
    // we will keep track of elements in the window using a map while incresing j if the value of new element is aready present in the map we will keep removing elements from the map util the value of the new element is not present in the map 
    // we will keep track of the maximum length of the subarray using ans variable
    // for example if the array is [3 3 3 3 5 1 5 1 1 4 ] the logest subarray with distinct element is [3 5 1] with length 3 
